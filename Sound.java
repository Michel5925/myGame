...
public class Sound {
    ...
    URL soundURL[] = new URL[30]; // Stores file path
    FloatControl fc;
    int volumeScale = 3;
    float volume;
    ...
    public Sound() {
        ...
        soundURL[0] = getClass().getResource("/sound/2Doriginal.wav");
        ...
        soundURL[16] = getClass().getResource("/sound/Merchant.wav");
    ...
    public void setFile(int i) {
        // FORMAT FOR GETTING AUDIO CLIPS
        try {
