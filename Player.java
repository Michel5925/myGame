...
public class Player extends Entity {
    ...
    public void setDefaultValues() {
        ...
        attack = getAttack(); // The total attack value is decided by attack and weapon
    ...
    public void getImage() {
        ...
        // up1 = setup("/player/girlUp", gp.tileSize, gp.tileSize*2);
        // up2 = setup("/player/girlUp", gp.tileSize, gp.tileSize*2);
        // down1 = setup("/player/girlDown", gp.tileSize, gp.tileSize*2);
        // down2 = setup("/player/girlDown", gp.tileSize, gp.tileSize*2);
        // left1 = setup("/player/girlLeft1", gp.tileSize, gp.tileSize*2);
        // left2 = setup("/player/girlLeft2", gp.tileSize, gp.tileSize*2);
        // right1 = setup("/player/girlRight1", gp.tileSize, gp.tileSize*2);
        // right2 = setup("/player/girlRight2", gp.tileSize, gp.tileSize*2);
    }
    ...
    public void interactNPC(int i) {
        ...
        {
            if(gp.keyH.enterPressed == true && i != 999)
            {
                attackCanceled = true;
